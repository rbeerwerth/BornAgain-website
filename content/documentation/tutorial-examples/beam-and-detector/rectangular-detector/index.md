...
> See the [Detector types]({{% relref "documentation/working-with-python/detectors" %}}) tutorial for detailed explanations about various detector types in BornAgain.
